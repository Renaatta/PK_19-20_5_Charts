...
namespace Charts
{
    public partial class Form : System.Windows.Forms.Form
    {
        ...
        {
            UserControlPolinomial newPolinomial = new UserControlPolinomial();
            flowLayoutPanelControls.Controls.Add(newPolinomial);

            newPolinomial.FunctionChanged += FunctionChanged;
            FunctionChanged();
        }
